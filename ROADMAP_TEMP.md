...
有兩個 story 的 spec **明文禁止在特定證據補齊前標 Done**。程式碼可以先 merge
(下游需要),但 PROGRESS.md 狀態不得標 `approved`,必須留在 `in-progress`
並在備註寫明缺什麼、等誰。

| Story | 缺的證據 | 解鎖條件 | 目前狀態 |
|---|---|---|---|
| E03-S035 | AC5(L5):登入後第二分頁／重整／登出的跨分頁 session 存活 E2E | W7 的 **E03-S038** merge 後由 W1 回補 | 程式碼已 merge(349ec67),狀態 `in-progress` |
| E12-S030 | 真實中英夾雜音檔通過 `verify-asr`(spec 第 69 行) | **使用者**在目標機器手動錄音並跑通 | 尚未開工 |

> 依 spec E03-S035 第 202/205 行與 E12-S030 第 69 行。這兩個 story 是本批
> 39 個裡**唯二**有這種條款的(已全量 grep 確認),其餘 37 個沒有這種限制。
> **完成定義因此有順序約束**:E03-S035 不可能早於 E03-S038 達到 approved。

## 6. 進度勾選

- [ ] W1:~~S034~~ ✅(aae4fb3) S035 S036 S037 S039 S043 S044
- [ ] W2:E02-S032 S033 S034 E04-S048 S047 E11-S026 E13-S021
- [ ] W3:E04-S041 S042 S043 S044 E13-S019
- [ ] W4:E01-S021 S022 S023 S024 S025
- [ ] W5:~~E03-S040~~ ✅(8472489) S042 E12-S031 E03-S041 E03-S045
