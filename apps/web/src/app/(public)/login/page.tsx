...
/**
 * Login page (E01-S002). Local login is wired to a mock AuthClient (see
 * apps/web/src/lib/auth.ts) until the E02 contract exists. Redirect after
 * success is E01-S003's job; establishing the app session is E01-S004's —
 * this story only owns the form's own visual/interaction states.
 */
