...
## Metadata
- Epic: E05 — Knowledge Management Experience
- Owner: Team A
...
## User / System Value
完成「Knowledge list page」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
...
## User / System Value
完成「Knowledge search/filter」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
...
## User / System Value
完成「Create KB form」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
...
## User / System Value
完成「Edit KB metadata」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
...
## User / System Value
完成「KB detail page」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
...
## User / System Value
完成「KB permission editor」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
...
## User / System Value
完成「KB member editor」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
...
## User / System Value
完成「KB prompt binding UI」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
...
## User / System Value
完成「KB model binding UI」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
...
## User / System Value
完成「KB document list」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
...
## User / System Value
完成「Single-file upload」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
...
## User / System Value
完成「Multi-file upload」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
...
## User / System Value
完成「Folder upload」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
...
## User / System Value
完成「URL import」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
...
## User / System Value
完成「Text knowledge input」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
...
## User / System Value
完成「Folder sync setup UI」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
...
## User / System Value
完成「Upload progress」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
...
## User / System Value
完成「Parse progress」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
...
## User / System Value
完成「Index progress」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
...
## User / System Value
完成「Processing failure state」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
...
## User / System Value
完成「Retry processing action」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
...
## User / System Value
完成「Document preview」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
...
## User / System Value
完成「Document metadata editor」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
...
---
# E05-S024 — Document version history
...
## User / System Value
完成「Document version history」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
...
## User / System Value
完成「Archive document action」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
...
## User / System Value
完成「Delete document confirmation」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
...
## User / System Value
完成「Document permission editor」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
...
## User / System Value
完成「KB usage stats thin slice」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
...
## User / System Value
完成「document state badges」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
...
## User / System Value
完成「bulk document selection/actions」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
...
## User / System Value
完成「Knowledge UI E2E」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
