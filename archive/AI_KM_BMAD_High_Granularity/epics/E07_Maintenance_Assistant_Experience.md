...
## Metadata
- Epic: E07 — Maintenance Assistant Experience
- Owner: Team A
...
## User / System Value
完成「Maintenance home」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
...
## User / System Value
完成「Equipment selector」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
...
## User / System Value
完成「Serial-number input」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
...
## User / System Value
完成「Error-code search UI」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
...
## User / System Value
完成「Problem description input」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
...
## User / System Value
完成「Diagnostic session shell」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
...
## User / System Value
完成「Current-step card」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
...
## User / System Value
完成「Decision options」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
...
## User / System Value
完成「Free-text detail」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
...
## User / System Value
完成「Previous-step action」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
...
## User / System Value
完成「Restart diagnostic」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
...
## User / System Value
完成「Skip-step UX with reason」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
...
## User / System Value
完成「Photo upload」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
...
## User / System Value
完成「AI explain-step panel」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
...
## User / System Value
完成「SOP citation component」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
...
## User / System Value
完成「Safety warning component」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
...
## User / System Value
完成「High-risk confirmation gate」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
...
## User / System Value
完成「Escalation action」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
...
## User / System Value
完成「Completion summary」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
...
## User / System Value
完成「Maintenance history」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
...
## User / System Value
完成「Case detail」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
...
## User / System Value
完成「Maintenance report view/export」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
...
## User / System Value
完成「Knowledge candidate submission」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
...
## User / System Value
完成「session-resume UX」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
...
## User / System Value
完成「maintenance E2E」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
