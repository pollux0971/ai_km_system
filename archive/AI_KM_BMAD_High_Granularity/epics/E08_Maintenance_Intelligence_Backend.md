...
---
# E08-S001 — EquipmentModel entity

## Metadata
- Epic: E08 — Maintenance Intelligence Backend
- Owner: Team B
...
## User / System Value
完成「EquipmentModel entity」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
...
---
# E08-S002 — Equipment instance entity
...
## User / System Value
完成「Equipment instance entity」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
...
## User / System Value
完成「ErrorCode entity」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
...
---
# E08-S004 — Error-code search API
...
## User / System Value
完成「Error-code search API」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
...
---
# E08-S005 — DecisionTree entity/version
...
## User / System Value
完成「DecisionTree entity/version」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
...
## User / System Value
完成「DecisionNode entity」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
...
## User / System Value
完成「DecisionEdge entity」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
...
---
# E08-S008 — Diagnostic session create
...
## User / System Value
完成「Diagnostic session create」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
...
---
# E08-S009 — Session state persistence
...
## User / System Value
完成「Session state persistence」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
...
---
# E08-S010 — Node transition engine
...
## User / System Value
完成「Node transition engine」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
...
---
# E08-S011 — Previous-step transition
...
## User / System Value
完成「Previous-step transition」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
...
## User / System Value
完成「Restart transition」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
...
---
# E08-S013 — Decision validation rule engine
...
## User / System Value
完成「Decision validation rule engine」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
...
---
# E08-S014 — Safety warning rule engine
...
## User / System Value
完成「Safety warning rule engine」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
...
## User / System Value
完成「SOP link resolver」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
...
---
# E08-S016 — RAG explanation adapter
...
## User / System Value
完成「RAG explanation adapter」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
...
---
# E08-S017 — MaintenanceRecord entity
...
## User / System Value
完成「MaintenanceRecord entity」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
...
## User / System Value
完成「Completion workflow」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
...
## User / System Value
完成「Escalation workflow」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
...
---
# E08-S020 — KnowledgeCandidate entity
...
## User / System Value
完成「KnowledgeCandidate entity」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
...
---
# E08-S021 — Human approval workflow
...
## User / System Value
完成「Human approval workflow」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
...
---
# E08-S022 — Maintenance writeback adapter contract
...
## User / System Value
完成「Maintenance writeback adapter contract」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
...
---
# E08-S023 — decision-tree cycle validation
...
## User / System Value
完成「decision-tree cycle validation」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
...
---
# E08-S024 — session concurrency control
...
## User / System Value
完成「session concurrency control」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
...
---
# E08-S025 — maintenance audit events
...
## User / System Value
完成「maintenance audit events」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
...
---
# E08-S026 — maintenance integration tests
...
## User / System Value
完成「maintenance integration tests」的單一可驗證能力；不得把相鄰功能、未定義平台能力或 GA 擴充偷偷併入本 Story。
