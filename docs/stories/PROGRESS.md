...
| E03 AI Conversation Experience | 33 | 27 | 1 | 0 | 0 | 5 |
...
| E03-S028 | done | story/E03-S028-file-chat-entry-flow | [E03-S028.md](E03-S028.md) | DEV 完成,待獨立審核(File-chat entry flow,epic 展開標題「entry flow」限定為新進入點,非 S008 附件選擇器的變形;新增獨立路由 /conversations/new-file,S001 的 /conversations/new 完全未觸碰(已用 S001 自己的既有 E2E 測試逐字驗證零回歸);sendMessage 失敗時 rollback deleteConversation,避免留下部分建立的幽靈對話;成功導向對話詳情頁而非列表頁;0 次 FIX 循環;獨立重跑 typecheck/lint/build/423 unit/27 個目標 E2E 皆綠,force 全量兩輪皆綠;完整記錄「retrofit S001 vs 新增獨立進入點」的選項權衡分析) |
| E03-S029 | todo | | | |
| E03-S030 | todo | | | |
| E03-S031 | todo | | | |
| E03-S032 | todo | | | |
