...
| E05 Knowledge Management Experience | 31 | 5 | 1 | 0 | 0 | 25 |
...
| E05-S006 | done | story/E05-S006-kb-permission-editor | [E05-S006.md](E05-S006.md) | 1 次 FIX 循環(文字節點分割導致的 exact-match 斷言問題,已根因修正);typecheck/lint/unit(529)/build/E2E 隔離(2+32)/E2E 全量 force 兩輪(121)皆綠;開工前已跑 `/advisor` 分析權限模型與「不可假強制執行」邊界,見 EVIDENCE |
| E05-S007 | todo | | | |
| E05-S008 | todo | | | |
| E05-S009 | todo | | | |
| E05-S010 | todo | | | |
