...
|---|---|---|---|---|---|---|
| E01 Application Shell & User Workspace | 20 | 17 | 1 | 0 | 0 | 2 |
...
| E01-S018 | done | story/E01-S018-app-level-error-boundary | [E01-S018.md](E01-S018.md) | 2 輪 FIX 後全過(私有資料夾路由排除 + Playwright role="alert" 歧義);待獨立審核 |
| E01-S019 | todo | | | |
| E01-S020 | todo | | | |
