...
| E05 Knowledge Management Experience | 31 | 6 | 1 | 0 | 0 | 24 |
...
| E05-S007 | done | story/E05-S007-kb-member-editor | [E05-S007.md](E05-S007.md) | 0 次 FIX 循環;typecheck/lint/unit(552)/build/E2E 隔離(2+34)/E2E 全量 force 兩輪(123)皆綠;延續 S006 的「純設定非強制執行」邊界,member 為不透明識別字串(無真正使用者目錄) |
| E05-S008 | todo | | | |
| E05-S009 | todo | | | |
| E05-S010 | todo | | | |
| E05-S011 | todo | | | |
