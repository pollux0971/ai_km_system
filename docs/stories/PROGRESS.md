...
| E03 AI Conversation Experience | 33 | 25 | 1 | 0 | 0 | 7 |
...
| E03-S026 | done | story/E03-S026-archive-unarchive-conversation | [E03-S026.md](E03-S026.md) | DEV 完成,待獨立審核(Archive/unarchive conversation,epic 展開標題確認雙向可逆;listConversations 新增 archived view-selector 第三參數,預設值向後相容,唯一呼叫端已同步;getRecentConversations 排除已封存對話;archiveConversation/unarchiveConversation 皆 NOT_FOUND fail-closed;UI 無確認步驟(可逆動作,對稱 S024/反 S025 理由);0 次 FIX 循環;獨立重跑 typecheck/lint/build/406 unit/30 個目標 E2E 皆綠,force 全量兩輪皆綠) |
| E03-S027 | todo | | | |
| E03-S028 | todo | | | |
| E03-S029 | todo | | | |
| E03-S030 | todo | | | |
