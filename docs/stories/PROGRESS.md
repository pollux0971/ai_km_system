...
| E07 Maintenance Assistant Experience | 25 | 6 | 1 | 0 | 0 | 18 |
...
| E07-S007 | done | story/E07-S007-current-step-card | [E07-S007.md](E07-S007.md) | 開工前 `/advisor` 分析後自主採納:不 model Team B 決策樹分支,`lib/diagnostic-steps.ts` 新增單一、明確標示模擬(「（模擬步驟）」,同 answer-state.ts 慣例)、不持久化的 `DiagnosticStep`；取代 S006 自己 EVIDENCE 預告的佔位文字;0 次 FIX 循環,972 unit + 164 E2E 全綠;S006 既有 E2E 斷言依其自身 AC 合理取代(同 E05-S020→S029 先例),已用對抗性還原驗證新測試確實把關;待 `/story-review` 獨立審核 |
| E07-S008 | todo | | | |
| E07-S009 | todo | | | |
| E07-S010 | todo | | | |
| E07-S011 | todo | | | |
