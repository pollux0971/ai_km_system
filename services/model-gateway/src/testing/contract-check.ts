 ...
 * Deliberate duplication of `services/conversation/src/testing/
 * contract-check.ts`'s loading/validation logic — same reasoning: a
 * service package cannot depend on `apps/api`, and this story's
 * development boundary only allows changes under
