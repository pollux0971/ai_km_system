...
/**
 * E01-S007 critical flow: the home dashboard's own content (greeting +
 * placeholder sections), distinct from the shell chrome E01-S005 covers.
 */
test("home dashboard greets the user and shows placeholder widget sections", async ({ page }) => {
